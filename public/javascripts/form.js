export default function inner(options) {
return `
...
<section class="form-content">
  <article class="user">
    <h3 class="user__heading">${options.nameHeading}</h3>
    <form action="/${options.form}" method="post" id="form-${options.form}">
    <div class="form-group">
        <div class="user__input">
          <i class="fa-solid fa-user user__input-icon"></i>
          <input type="text" placeholder="Username" name="username" class="user__input-name" id="">
        </div>
        <span class="form-message"></span>
      </div>  
    <div class="form-group">
        <div class="user__input">
        <i class="fa-solid fa-envelope user__input-icon"></i>
          <input type="email" placeholder="email" name="email" class="user__input-email" id="">
        </div>
        <span class="form-message"></span>
      </div>
      <div class="form-group">
        <div class="user__input">
          <i class="fa-solid fa-lock user__input-icon"></i>
          <input type="password" placeholder="Password" name="password" class="user__input-pass" id="">
        </div>
        <span class="form-message"></span>
      </div>
      <div class="form-group">
        <div class="user__input user__input--${options.displayInput}">
          <i class="fa-solid fa-lock user__input-icon"></i>
          <input type="password" placeholder="Confirm Password" name="confirmpassword" class="user__input-conf" id="">
        </div>
        <span class="form-message"></span>
      </div>
      <button class="user__btn">${options.nameBtn}</button>
    </form>
    <div class="user-info">
      <a href="" class="user-info__forgot forgot--${options.displayLink}">Forgot Password</a>
      <a href="" class="user-info__sin text--style">${options.nameFt}</a>
    </div>
  </article>
  <article class="modal__content-image">
    <svg class="modal__content-image-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
      <g id="freepik--Shadow--inject-7">
        <ellipse id="freepik--path--inject-7" cx="250" cy="415.69" rx="193.89" ry="11.32" style="fill:#f5f5f5">
        </ellipse>
      </g>
      <g id="freepik--Device--inject-7">
        ...
        <ellipse cx="294.81" cy="224.63" rx="33.73" ry="30.9" transform="translate(-73.49 266.21) rotate(-43.75)"
      ...
      <g id="freepik--Document--inject-7">
        <path
        ...
        <path
          ...
          style="opacity:0.2"></path>
        <rect x="178.67" y="200.79" width="64.22" height="19.09" rx="6.35" style="fill:#407BFF">
        </rect>
        <path
      ...
      <g id="freepik--Character--inject-7">
        ...
        <path d="M204,213.38l2.33-7.49,6.14,3.06s-.9,5.46-5.36,6.41Z" style="fill:#b55b52"></path>
        <polygon points="208.78 203.82 214.32 205.34 212.46 208.95 206.32 205.89 208.78 203.82" style="fill:#b55b52">
        </polygon>
        <path
          ...
          style="fill:#b55b52"></path>
        <path d="M141.63,232.35l4.12-2.11,1.82,7s-3.31,1.27-5.87-.36Z" style="fill:#b55b52"></path>
        <polygon points="151.45 227.99 151.64 234.43 147.03 237.44 145.43 230.37 151.45 227.99" style="fill:#b55b52">
        </polygon>
        <path d="M164.94,168.47c.1.49.45.84.77.78s.51-.52.41-1-.45-.84-.77-.78S164.84,168,164.94,168.47Z"
          style="fill:#263238"></path>
        <path d="M165.34,169.32a18.21,18.21,0,0,0,3.23,3.76,2.92,2.92,0,0,1-2.28.93Z" style="fill:#a02724"></path>
        <path
        ...
        <path
          ...
          style="fill:#b55b52"></path>
        <path d="M147.56,192.34c-.68-1.27-1.44-2.73.12-3.19,1.72-.5,12.75-1.43,16-.49-1,1.77.69,4,.69,4Z"
          style="fill:#263238"></path>
        <polygon points="156.7 406.92 163.91 406.92 164.63 392.4 157.41 392.4 156.7 406.92" style="fill:#b55b52">
        </polygon>
        <polygon points="110.91 404.92 118.22 405.31 122.66 391 115.35 390.61 110.91 404.92" style="fill:#b55b52">
        </polygon>
        <path
        ...
        <path
          ...
          style="fill:#263238"></path>
        <path d="M143,203.29c-2.43,3.78-2.2,9.62-1.36,14.55l.6.28a25.83,25.83,0,0,0,3.6-12.67c0-.48,0-1,0-1.43Z"
        ...
        <path d="M176.24,207.49l-.12-.11-6.67-3.56c-.68,10.27,3.91,16.71,6.64,19.52A143.39,143.39,0,0,0,176.24,207.49Z"
          style="opacity:0.2"></path>
        <polygon points="164.63 392.4 164.26 399.89 157.04 399.89 157.41 392.4 164.63 392.4" style="opacity:0.2">
        </polygon>
        <polygon points="115.35 390.62 122.66 391 120.37 398.38 113.06 397.99 115.35 390.62" style="opacity:0.2">
        </polygon>
        <path
        ...
        <path
          ...
          style="fill:#263238"></path>
        <path d="M126.24,394.25s-2.1,4.06-2.1,4.06l-12.62-2.74,1.06-3.79Z" style="fill:#407BFF">
        </path>
        <path d="M126.24,394.25s-2.1,4.06-2.1,4.06l-12.62-2.74,1.06-3.79Z" style="fill:#fff;opacity:0.6000000000000001">
        </path>
        <path
        ...
        <path
          ...
          style="fill:#263238"></path>
        <path d="M168.25,394.21c.05,0-.6,4.41-.6,4.41H154.73l-.35-3.94Z" style="fill:#407BFF">
        </path>
        <path d="M168.25,394.21c.05,0-.6,4.41-.6,4.41H154.73l-.35-3.94Z" style="fill:#fff;opacity:0.6000000000000001">
        </path>
        <path
          d="M169.4,202c0,12.58,6.69,17.76,6.69,17.76L187,209.14a89.8,89.8,0,0,0-8.79-12.23C171.9,189.68,169.4,193.92,169.4,202Z"
          style="fill:#263238"></path>
        <path d="M166.52,178.24a4.1,4.1,0,0,1-2.82,2.6,3.38,3.38,0,0,0-2.69,3l0,0A8.66,8.66,0,0,0,166.52,178.24Z"
          style="opacity:0.2"></path>
        <path
